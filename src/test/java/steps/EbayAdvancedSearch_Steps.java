...
public class EbayAdvancedSearch_Steps {
	Common_Actions common_actions;//declaration
	...
	//created contructor for this class and passed parameters of these to pages to make use of those methods declared in that page
	{
		this.common_actions = common_actions;//this means current class object
	...
	public void i_am_Ebay_Advanced_Search_Page() throws InterruptedException {
		common_actions.goToUrl("https://www.ebay.com/sch/ebayadvsearch");//in common class we are using this meathod syntax constructor name.metathod name
	}
	...
	public void i_am_navigated_to_Ebay_Home_Page() {
	    ...
	    String actUrl = common_actions.getCurrentPageTitle();
